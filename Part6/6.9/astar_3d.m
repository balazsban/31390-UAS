        ...
        for x = -1:1
            for y = -1:1
                for z = -1:1
                    ...
                    if ~((x == 0 && y == 0 && z == 0) || (abs(x) + abs(y) + abs(z) > 1))
                            ...
                            if ~(map(node_pos(1), node_pos(2), node_pos(3)) == 1)
                                ...
                                for child_i = 1:length(children)
                                    if node_pos == children(child_i).position
                                        % Note that this node is not 
                                        % to be added to children
                                        new_g = parent_node.g + children(child_i).calc_dist_3d(parent_node.position);
                                ...
                                temp_node.g = parent_node.g + temp_node.calc_dist_3d(parent_node.position);
